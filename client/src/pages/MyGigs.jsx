...
import { FiMessageSquare, FiDollarSign, FiStar, FiCalendar, FiTrash2, FiExternalLink, FiPlus } from 'react-icons/fi';
            ...
            <AnimatePresence>
              {gigs.map((gig) => (
                <motion.div
                  ...
                  onHoverStart={() => setHoveredGig(gig._id)}
                  onHoverEnd={() => setHoveredGig(null)}
                >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center flex-wrap gap-3 text-sm text-gray-600">
                          <div className="flex items-center bg-gray-100 px-3 py-1 rounded-full">
                            ...
                            <span>{format(new Date(gig.created_at), 'MMM dd')}</span>
                          </div>
                          {!gig.is_volunteer && (
                            <div className="flex items-center bg-gray-100 px-3 py-1 rounded-full">
                              <FiDollarSign className="w-4 h-4 mr-1" />
                              <span>${gig.budget_range_min}-${gig.budget_range_max}</span>
                            </div>
                          )}
                        </div>
                                ...
                                <div className="text-right flex items-center space-x-4">
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <button
                                      ...
                                      className="w-full px-2 py-1 bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 text-sm flex items-center space-x-1"
                                    >
              ...
              <div className="col-span-full text-center py-12">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-gray-600 mb-4">
                    Start by creating your first gig to find skilled professionals
                  </p>
                  <button
